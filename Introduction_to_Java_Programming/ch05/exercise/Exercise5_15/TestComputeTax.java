public class TestComputeTax { 
    public static void main(String[] args) {
		...
		for (int i = 0; i <= 200; i++) {
			System.out.print((50000 + i * 50) + "\t");
			System.out.print(computeTax(0, 50000 + i * 50) + "\t");
			System.out.print(computeTax(1, 50000 + i * 50) + "\t");
			System.out.print(computeTax(2, 50000 + i * 50) + "\t");
			System.out.print(computeTax(3, 50000 + i * 50) + "\n");
		}
	}
