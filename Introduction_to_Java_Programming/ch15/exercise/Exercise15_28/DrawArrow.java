...
public class DrawArrow extends JFrame {
	private ArrowPanel arrow = new ArrowPanel();
    private JButton jbt = new JButton("Draw a Random Arrow Line");
	public DrawArrow() {
	...
	public static void main(String[] args) {
		DrawArrow frame = new DrawArrow();
		frame.setTitle("Exercise15.28");
